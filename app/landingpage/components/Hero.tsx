...
export default function Hero() {
  return (
    <section
      id="home"
      className="bg-[#fcfaf2] px-2 py-20 md:py-20 lg:py-24 overflow-hidden">
      <div className="relative mx-auto w-full max-w-7xl sm:max-w-6xl rounded-4xl shadow-2xl overflow-visible">

        {/* IMAGE */}
        <div className="relative h-140 md:h-160 lg:h-160 w-full border-2 border-[#fdfbf2] rounded-3xl overflow-hidden">
          <Image
            src="/bus.png"
            alt="School Bus"
            fill

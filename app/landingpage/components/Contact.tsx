            ...
            <div className="text-white space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className={`${nunito.className} inline-flex items-center justify-center gap-2 rounded-xl bg-blue-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-950`}
                  >
                    Send Request
